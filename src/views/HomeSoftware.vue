                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sofftware-progress-images_media text-center wow move-up">
                            <img src="../assets/img/features/stabilitas-software-image-05.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="software-contact-images__midea text-center wow move-up">
                            <img src="../assets/img/features/stabilitas-software-image-06.png" alt="images" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
