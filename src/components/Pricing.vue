    ...
    export default {
        ...
        data (){
            return {
                pricingTable: [
                    {
                        thumb: require('../assets/img/pricing/stabilitas-branding-pricing-image-01.png'),
                        title: 'Free',
                        value: '0',
                        duration: 'mo',
                        alt: 'Pricing Thumb',
                    ...
                    {
                        thumb: require('../assets/img/pricing/stabilitas-branding-pricing-image-02.png'),
                        title: 'Personal',
                        value: '19',
                        duration: 'mo',
                        alt: 'Pricing Thumb',
                    ...
                    {
                        thumb: require('../assets/img/pricing/stabilitas-branding-pricing-image-03.png'),
                        title: 'Group',
                        value: '29',
                        duration: 'mo',
                        alt: 'Pricing Thumb',
                    ...
                    {
                        thumb: require('../assets/img/pricing/stabilitas-branding-pricing-image-04.png'),
                        title: 'Enterprise',
                        value: '49',
                        duration: 'mo',
                        alt: 'Pricing Thumb',
