                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 wow move-up">
                                    <div class="payment-hero--images__midea">
                                        <img src="../../assets/img/hero/payments/stabilitas-payment-hero-image.png" alt="hero thumb" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    export default {
        data (){
            return {
                bgImg: {
                    backgroundImage: `url(${require('../../assets/img/hero/payments/stabilitas-payment-hero-bg.jpg')})`
                }
            }
        }
    }
