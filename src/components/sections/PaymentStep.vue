                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="payment-process-step__media text-center">
                                        <img src="../../assets/img/features/stabilitas-payment-image-01.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="payment-process-step__content float-md-right">
                                        <div class="payment-process__inner">
                                            <h4 class="font-weight--blod section-space--mb_40">Effortless billing with Stabilitas
                                                <sup>01</sup>
                                            </h4>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7 order-1 order-lg-2">
                                    <div class="app-showcase-process-step__media text-center">
                                        <img src="../../assets/img/features/stabilitas-payment-image-02.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
