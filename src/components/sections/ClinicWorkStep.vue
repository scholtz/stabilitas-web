        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-wrapper text-center section-space--pb_90">
                        <h6 class="section-sub-title mb-20 font-weight--bold wow move-up">How Stabilitas works?</h6>
                        <h2 class="section-title font-weight--blod wow move-up">Stabilitas helps you find the right help</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 wow move-up">
                        <div class="clinic-work-step__media images-left-ml  text-center">
                            <img src="../../assets/img/features/stabilitas-clinic-image-01.png" class="img-fluid" alt="thumbnail">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 order-lg-2 order-1 wow move-up">
                        <div class="clinic-work-step__media images-right-mr  text-center">
                            <img src="../../assets/img/features/stabilitas-clinic-image-02.png" class="img-fluid" alt="thumbnail">
                        </div>
                    </div>
            ...
            <div class="clinic-work-process-step  section-space--pt_90">
                <div class="row">
                    <div class="col-lg-6 wow move-up">
                        <div class="clinic-work-step__media images-left-ml  text-center">
                            <img src="../../assets/img/features/stabilitas-clinic-image-03.png" class="img-fluid" alt="thumbnail">
                        </div>
                    </div>
                    <div class="col-lg-6 wow move-up">
                        <div class="clinic-work-process-step__content">
                            <div class="app-showcase__inner">
                                ...
                                <h4 class="font-weight--bold">Introduct App for Stabilitas</h4>
                                <div class="sub-text section-space--mb_40">
                                    There’s no need to be a technical professional to create sites with Stabilitas. With simple guides, everything is easy! We deliver the best services for app design and coding.
                                </div>
                                <div class="btn-sowcase">
                                    <div class="button-group-wrap">
                                        <a href="#" class="image-btn img-fluid me-2">
                                            <img src="../../assets/img/icons/stabilitas-black-button-google-play.jpg" alt="thumbnail">
                                        </a>
                                        <a href="#" class="image-btn img-fluid">
                                            <img src="../../assets/img/icons/stabilitas-button-app-store-dark.jpg" alt="thumbnail">
                                        </a>
                                    </div>
                                </div>
                            </div>
