        ...
        <div class="hero-item text-center">
            <div class="hero-content">
                ...
                <div class="hero-content-btn section-space--mt_40">
                    <router-link to=""><img src="../assets/img/icons/stabilitas-button-google-play.jpg" class="img-fluid" alt=""></router-link >
                    <router-link to=""><img src="../assets/img/icons/stabilitas-button-app-store.jpg" class="img-fluid" alt=""></router-link >
                </div>
            </div>
