                ...
                <div class="col-lg-6">
                    <div class="app-showcase__content">
                        <div class="app-showcase__inner">
                            ...
                            <h6 class="sub-heading wow move-up">What’s next in Stabilitas? <router-link to="/showcase" class="hover-style-link  hover-style-link--green">Learn more</router-link>
                            </h6>
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        data() {
            return {
                thumbnail: require("../assets/img/banners/stabilitas-app-showcase-image-02.png"),
