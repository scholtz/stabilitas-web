                        ...
                        <div class="content-wrapper text-center">
                            ...
                            <div class="start-ups-background__links section-space--mt_40 wow move-up">
                                <router-link :to="{ path: 'branding' }" class="mb-2 mb-sm-0">
                                    <img src="../assets/img/icons/stabilitas-button-google-play.jpg" class="img-fluid" alt="playstore btn">
                                </router-link>
                                <router-link :to="{ path: 'branding' }">
                                    <img src="../assets/img/icons/stabilitas-button-app-store.jpg" class="img-fluid" alt="applestore btn">
                                </router-link>
                            </div>
                        </div>
                    </div>
