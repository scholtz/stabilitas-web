                        ...
                        <div class="swiper-container testimonial-slider__container">
                            <div class="swiper-wrapper testimonial-slider__wrapper">
                                ...
                                >
                                    ...
                                    <swiper-slide class="swiper-slide">
                                        <div class="testimonial-slider__one">
                                            <div class="testimonial-slider__text">“Working with Stabilitas is like having a family member who can fix everything! Amazing fast and reliable support!”</div>
                                            <div class="testimonial-slider--info">
                                                <div class="post-thumbnail">
                                                    <img src="../assets/img/team/avatar-07-60x60.png" class="img-fluid" alt="">
                                                </div>
                                    ...
                                    <swiper-slide class="swiper-slide">
                                        <div class="testimonial-slider__one">
                                            <div class="testimonial-slider__text">@Stabilitas was unbelievably helpful to me when I need to find a responsive HTML template for my upcoming websites.</div>
                                            <div class="testimonial-slider--info">
                                                <div class="post-thumbnail">
                                                    <img src="../assets/img/team/avatar-07-60x60.png" class="img-fluid" alt="">
                                                </div>
