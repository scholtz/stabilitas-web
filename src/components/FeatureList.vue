        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="feature-icon-list__media wow move-up">
                    <img src="../assets/img/features/stabilitas-feature-icon-image.png" class="img-fluid" alt="">
                </div>
            </div>
            <div class="col-lg-6">
    ...
    export default {
        data (){
            return {
                features: [
                    {
                        icon: require('../assets/img/icons/stabilitas-branding-box-image-01-1.png'), 
                    ...
                    {
                        icon: require('../assets/img/icons/stabilitas-branding-box-image-02-1.png'), 
                        title: 'Highly Responsive Tools', 
                        desc: 'Apps are built based on highly compatible design for all kinds of Internet browsers.'
                    },
                    {
                        icon: require('../assets/img/icons/stabilitas-branding-box-image-03-1.png'), 
