                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="saas-background__links section-space--mt_40 wow move-up">
                                <router-link :to="{path: 'Branding'}">
                                    <img src="../assets/img/icons/stabilitas-button-google-play.jpg" class="img-fluid" alt="">
                                </router-link>
                                <router-link :to="{path: 'Branding'}">
                                    <img src="../assets/img/icons/stabilitas-button-app-store.jpg" class="img-fluid" alt="">
                                </router-link>
                            </div>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        data () {
            return {
                bgImg: {
                    backgroundImage: `url(${require('../assets/img/bg/stabilitas-sass-image-04.jpg')})`
                },
            }
        }
    };
