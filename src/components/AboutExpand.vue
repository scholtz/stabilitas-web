    ...
    export default {
        ...
        data (){
            return {
                abouts: [
                    {
                        icon: require('../assets/img/box-image/stabilitas-branding-box-image-01-180x180.png'), 
                        title: 'Social media boost'
                    },
                    {
                        icon: require('../assets/img/box-image/stabilitas-branding-box-image-02-180x180.png'), 
                        title: 'In-depth research analysis'
                    },
                    {
                        icon: require('../assets/img/box-image/stabilitas-branding-box-image-03-180x180.png'), 
