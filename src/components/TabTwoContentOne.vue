        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="tab-history-image">
                    <img src="../assets/img/banners/stabilitas-tab-content-image-04.png" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-5">
                <div class="tab-content-inner">
                    ...
                    <h6 class="sub-heading">What’s next in Stabilitas? <a href="#" class="hover-style-link hover-style-link--green">Learn more</a></h6>
                </div>
            </div>
        </div>
    </div>
