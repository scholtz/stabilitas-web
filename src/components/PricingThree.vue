                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12">
                        <div class="price-plan-wrap mt-30 section-space--mb_60">
                            ...
                            <h6 class="sub-heading wow move-up">What’s next for Stabilitas? <a href="#" class="hover-style-link hover-style-link--green">Learn more</a></h6>
                        </div>
                        ...
                        <div class="row pricing-table-three">
                                ...
                                <div class="pricing-table__inner">
                                    <div class="pricing-table__header">
                                        <div class="pricing-table__image">
                                            <img src="../assets/img/pricing/stabilitas-pricing-image-06.png" class="img-fluid" alt="">
                                        </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular wow move-up">
                                <div class="pricing-table__inner">
                                    ...
                                    <div class="pricing-table__header">
                                        <div class="pricing-table__image">
                                            <img src="../assets/img/pricing/stabilitas-pricing-image-05.png" class="img-fluid" alt="">
                                        </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 pricing-table wow move-up">
                                <div class="pricing-table__inner">
                                    <div class="pricing-table__header">
                                        <div class="pricing-table__image">
                                            <img src="../assets/img/pricing/stabilitas-pricing-image-07.png" class="img-fluid" alt="">
                                        </div>
