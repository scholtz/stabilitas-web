            ...
            <div class="row hero-startup">
                <div class="col-md-6">
                    <div class="hero-content">
                        ...
                        <h6 class="hero-content-subtitle mt-20">There’s no need to be a technical professional to create sites with Stabilitas. With simple guides, everything is easy!</h6>
