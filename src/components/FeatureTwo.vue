                                ...
                                <div class="feature-slider__single-slide-wrapper">
                                    <div class="row align-items-center">
                                        <div class="col-md-6 wow move-up">
                                            <div class="image">
                                                <img src="../assets/img/features/stabilitas-branding-image-10.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6 wow move-up">
                                            <div class="content">
                             ...
                             <swiper-slide class="feature-slider__single-slide">
                                <div class="feature-slider__single-slide-wrapper">
                                    <div class="row align-items-center">
                                        <div class="col-md-6 wow move-up">
                                            <div class="image">
                                                <img src="../assets/img/features/stabilitas-branding-image-11.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6 wow move-up">
                                            <div class="content">
                             ...
                             <swiper-slide class="feature-slider__single-slide">
                                <div class="feature-slider__single-slide-wrapper">
                                    <div class="row align-items-center">
                                        <div class="col-md-6 wow move-up">
                                            <div class="image">
                                                <img src="../assets/img/features/stabilitas-branding-image-12.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6 wow move-up">
                                            <div class="content">
