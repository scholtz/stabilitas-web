    ...
    export default {
        ...
        data(){
            return {
                pricingTable: [
                    {
                        thumb: require('../assets/img/pricing/stabilitas-pricing-image-06.png'),
                        title: 'Free',
                        value: '0',
                        alt: 'Pricing Thumb',
                        isPopular: false,
                    ...
                    {
                        thumb: require('../assets/img/pricing/stabilitas-pricing-image-05.png'),
                        title: 'Personal',
                        value: '49',
                        alt: 'Pricing Thumb',
                        isPopular: true,
                    ...
                    {
                        thumb: require('../assets/img/pricing/stabilitas-pricing-image-07.png'),
                        title: 'Group',
                        value: '99',
                        alt: 'Pricing Thumb',
                        isPopular: false,
