                        ...
                        <div class="ht-service-box--one style-03">
                            <router-link :to="'branding'">
                                <div class="image__media">
                                    <img :src="item.icon" class="img-fluid" alt="stabilitas-app-showcase-box-icon-image-01">
                                </div>
                                <div class="content">
    ...
    export default {
        ...
        data (){
            return {
                items: [
                    {
                        icon: require('../assets/img/icons/stabilitas-box-image-01.png'), 
                    ...
                    {
                        icon: require('../assets/img/icons/stabilitas-box-image-02.png'), 
                        heading: 'Extensive Documentation', 
                        text: 'Consider this app a platform for connecting people from everywhere based on their preferences.'
                    },
                    {
                        icon: require('../assets/img/icons/stabilitas-box-image-03.png'), 
                        heading: 'Customer Assistance', 
                        text: 'Consider this app a platform for connecting people from everywhere based on their preferences.'
                    },
                    {
                        icon: require('../assets/img/icons/stabilitas-box-image-04.png'), 
                        heading: 'Guaranteed Growth', 
                        text: 'Consider this app a platform for connecting people from everywhere based on their preferences.'
                    },
                    {
                        icon: require('../assets/img/icons/stabilitas-box-image-05.png'), 
                        heading: 'Plugins Integration', 
                        text: 'Consider this app a platform for connecting people from everywhere based on their preferences.'
                    },
                    {
                        icon: require('../assets/img/icons/stabilitas-box-image-06.png'), 
