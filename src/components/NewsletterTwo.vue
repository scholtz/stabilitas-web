<template>
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <!-- newsletter text -->
            <h6 class="sub-heading text-center wow move-up">What’s next in Stabilitas? <router-link to="" class="hover-style-link hover-style-link--green">Learn more</router-link></h6>
        </div>
    </div>
</template>