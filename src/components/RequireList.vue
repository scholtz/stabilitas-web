        ...
        <div class="row align-items-center">
            <div class="col-lg-6 order-2 order-xl-1">
                <div class="requirements-list">
                    ...
                    <p class="requirements-list__text heading mb-30 wow move-up">Stabilitas creates a prominent advantage for your business with strong features.</p>
            ...
            <div class="col-lg-6 order-1 order-xl-2">
                <div class="requirements-list-image wow move-up">
                    <img src="../assets/img/features/stabilitas-branding-image-both-laptop.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
